...
pacman::p_load(dplyr,tidyr,devtools, ggplot2, mapproj, readr, ggthemes, reshape2,maps, mapdata, ggmap, stringr, gstat,sp, automap,viridis)
```
...
```{r}
dat <- df %>%
  dplyr::select("YEAR", "LATITUDE","LONGITUDE", "INDUSTRY_SECTOR","CHEMICAL", "TOTAL_RELEASES") %>%
